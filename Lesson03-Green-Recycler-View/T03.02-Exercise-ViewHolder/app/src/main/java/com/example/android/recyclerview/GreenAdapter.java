...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        // DONE (16) Within the NumberViewHolder class, create a void method called bind that accepts
        // an int parameter called listIndex
        // DONE (17) Within bind, set the text of listItemNumberView to the listIndex
        // DONE (18) Be careful to get the String representation of listIndex, as using setText with
